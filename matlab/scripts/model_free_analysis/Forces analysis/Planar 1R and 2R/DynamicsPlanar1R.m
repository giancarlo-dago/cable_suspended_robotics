...
syms lAx lAy lAz fvA fsA mA iAxx iAyy iAzz LA g0 LC real;
syms pAy pAz real;

IA = [ iAxx, 0, 0; 0, iAyy, 0; 0, 0, iAzz ];
inertial_disp_A = [0 0 0]';
...
T = [1 0 0 0;
    0 cos(qA+qC) -sin(qA+qC) 0;
    0 sin(qA+qC) cos(qA+qC) -LC;
    0 0 0 1];

F_own_world = Ad_f(T)*F_own

% R_w1 = [1 0 0; 0 cos(qA+qC) -sin(qA+qC); 0 sin(qA+qC) cos(qA+qC)];
% % R_w1 = [1 0 0; 0 1 0; 0 0 1];
