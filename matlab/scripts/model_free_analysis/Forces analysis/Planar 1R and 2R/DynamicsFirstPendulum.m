...
syms lCx lCy lCz fvC fsC mC iCxx iCyy iCzz LC g0 real;
syms pCy pCz real;

IA = [ iCxx, 0, 0; 0, iCyy, 0; 0, 0, iCzz ];
...
Inertia(:,:,1) = IC;
mass = mC;
inertial_disp(1,:) = inertial_disp_C;
viscous_friction = fvC;
static_friction = fsC;
