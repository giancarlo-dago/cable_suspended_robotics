...
fileID = fopen('finalNatRes29.txt','w');
...
startIndex = find(tTemp>=T1,1,'first');
endIndex = find(tTemp>=T2,1,'first');
fileID = fopen('finalNatRes30.txt','w');
...
startIndex = find(tTemp>=T1,1,'first');
endIndex = find(tTemp>=T2,1,'first');
fileID = fopen('finalNatRes31.txt','w');
...
startIndex = find(tTemp>=T1,1,'first');
endIndex = find(tTemp>=T2,1,'first');
fileID = fopen('finalNatRes32.txt','w');
...
startIndex = find(tTemp>=T1,1,'first');
endIndex = find(tTemp>=T2,1,'first');
fileID = fopen('finalNatRes33.txt','w');
