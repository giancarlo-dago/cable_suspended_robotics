...
%% Save and plot data
TRAJ = [7 8 9 10 11 12]; nTraj = 6; nSamples = [864 912 1218 1100 857 815];          % natRes
...
xlabel('t [s]'); ylabel('$\mid e \mid$ [m]'); set(gca, 'FontSize',16); set(gca, 'XLim', [tModel{i}(j) tModel{i}(end)]);
grid on; box on; set(gcf,'color','w');
exportgraphics(h, 'ErrorLicasY3.pdf');  
...
xlabel('t [s]'); ylabel('$\mid e \mid$ [m]'); set(gca, 'FontSize',16); set(gca, 'XLim', [tModel{i}(j) tModel{i}(end)]);
grid on; box on; set(gcf,'color','w');
exportgraphics(h, 'ErrorLicasY4.pdf');
...
xlabel('t [s]'); ylabel('$\mid e \mid$ [m]'); set(gca, 'FontSize',16); set(gca, 'XLim', [tModel{i}(j) tModel{i}(end)]);
grid on; box on; set(gcf,'color','w');
exportgraphics(h, 'ErrorLicasY5.pdf');  
...
xlabel('t [s]'); ylabel('$\mid e \mid$ [m]'); set(gca, 'FontSize',16); set(gca, 'XLim', [tModel{i}(j) tModel{i}(end)]);
grid on; box on; set(gcf,'color','w');
exportgraphics(h, 'ErrorLicasY6.pdf');  
