function [qk, qdk] = qFunCranebotComplete(p,qPrev,qdPrev,Ts,qPrevRef,qdPrevRef)
    ...
    qddPrev = qddFunCranebotComplete(p,qPrev,qdPrev,qPrevRef,qdPrevRef);    % Compute qdd(k-1) from q(k-1) and qd(k-1)
