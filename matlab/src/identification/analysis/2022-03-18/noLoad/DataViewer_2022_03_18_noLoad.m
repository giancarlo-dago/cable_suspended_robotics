...
qL_integrated = cumtrapz(t,dqLdt);
index = index + 4;
...
figure(15)
subplot(2,1,1), plot(t, qL), grid
ylabel('q_L [deg]')
legend('q_1', 'q_2', 'q_3', 'q_4')
title('LEFT ARM JOINT POSITION')
subplot(2,1,2), plot(t, qL_integrated), grid
xlabel('time [s]')
ylabel('q_R [deg]')
title('LEFT ARM JOINT INTEGRATED')
...
legend('X', 'Y', 'Z')
subplot(2,1,2), plot(t, 180/pi*quat2eul(multirotorQuaternion(:,1:4), 'XYZ'))
ylabel('orientation [deg]')
legend('X', 'Y', 'Z')
xlabel('time [s]')
...
ylabel('position [m]')
legend('X', 'Y', 'Z')
subplot(2,1,2), plot(t, 180/pi*quat2eul(dualArmQuaternion(:,1:4), 'XYZ'))
ylabel('orientation [deg]')
legend('X', 'Y', 'Z')
xlabel('time [s]')
...
legend('X', 'Y', 'Z')
subplot(2,1,2), plot(t, 180/pi*quat2eul(powerLineQuaternion(:,1:4), 'XYZ'))
ylabel('orientation [deg]')
legend('X', 'Y', 'Z')
xlabel('time [s]')
